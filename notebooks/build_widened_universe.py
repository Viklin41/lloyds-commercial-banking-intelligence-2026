...
It writes a NEW file and does not touch Samuel's. NB01 stays as it is.
    ...
    in   data/raw/BasicCompanyDataAsOneFile-2026-06-01.csv
    out  data/processed/filtered_bb_sme_sectors_all_status.csv
...
OUTPUT_PATH = DATA / "processed" / "filtered_bb_sme_sectors_all_status.csv"
CHUNKSIZE = 50_000
...
print(f"  universe 1,372,321 -> {len(df):,}   (+{len(df)-active:,})")
