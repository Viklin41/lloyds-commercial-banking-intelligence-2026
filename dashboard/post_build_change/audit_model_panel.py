...
SPINE = str(_DATA / "processed" / "dashboard_bulk_gazette_2026-07.parquet")
REASONS = str(_HERE / "shortlist_reasons_2026-07.parquet")
META = str(_REPO / "dashboard" / "store_meta.json")
ANSWERS = str(_HERE / "meeting-answers-2026-08-25.md")
...
src = io.open(str(_REPO / "dashboard" / "serve.py"),
              encoding="utf-8").read()
